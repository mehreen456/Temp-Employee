...
open class SkyFloatingLabelTextField: UITextField { // swiftlint:disable:this type_body_length
    ...
    /// A UIColor value that determines text color of the placeholder label
     dynamic open var placeholderFont: UIFont = UIFont.init(name: "Lato", size: 12)! {
        didSet {
            updatePlaceholder()
        }
    }
    ...
    fileprivate func updatePlaceholder() {
        if let placeholder = placeholder, let font = placeholderFont ?? font {
            let mutableAttributedString :NSMutableAttributedString  = NSMutableAttributedString(string: placeholder)
            mutableAttributedString.addAttributes([NSFontAttributeName: font], range: NSRange.init(location: 0, length: placeholder.characters.count))
//            string: placeholder,
//            attributes: [NSForegroundColorAttributeName: placeholderColor, NSFontAttributeName: font]
            attributedPlaceholder = mutableAttributedString
        }
    }
    ...
    */
    ...
    fileprivate func createTitleLabel() {
        ...
        titleLabel.font = UIFont.init(name: "Lato-Light", size: 12)!
